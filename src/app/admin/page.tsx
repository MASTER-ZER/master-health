      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white border border-border p-5 rounded-2xl shadow-card flex items-center justify-between">
            <div>
              <p className="text-xs text-muted font-medium">إجمالي الحجوزات</p>
              <p className="text-2xl font-extrabold text-heading mt-1">{stats.total}</p>
            </div>
          ...
          <div className="bg-white border border-border p-5 rounded-2xl shadow-card flex items-center justify-between">
            <div>
              <p className="text-xs text-muted font-medium">بانتظار التأكيد</p>
              <p className="text-2xl font-extrabold text-warning-dark mt-1">{stats.pending}</p>
            </div>
            <div className="w-11 h-11 rounded-xl bg-warning-light text-warning-dark flex items-center justify-center">
          ...
          <div className="bg-white border border-border p-5 rounded-2xl shadow-card flex items-center justify-between">
            <div>
              <p className="text-xs text-muted font-medium">مواعيد مؤكدة</p>
              <p className="text-2xl font-extrabold text-success mt-1">{stats.confirmed}</p>
            </div>
          ...
          <div className="bg-white border border-border p-5 rounded-2xl shadow-card flex items-center justify-between">
            <div>
              <p className="text-xs text-muted font-medium">مواعيد ملغاة</p>
              <p className="text-2xl font-extrabold text-error mt-1">{stats.cancelled}</p>
            </div>
            <div className="w-11 h-11 rounded-xl bg-error-light text-error flex items-center justify-center">
        ...
        <div className="bg-white border border-border p-4 rounded-2xl shadow-card flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pr-11 pl-4 h-11 rounded-xl bg-background border border-border text-heading text-xs sm:text-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary transition-all"
            />
          </div>
              ...
              <button
                ...
                className={`px-3.5 py-1.5 rounded-xl text-xs font-bold transition-all ${
                  selectedStatus === tab.id
                    ...
                    : 'bg-background hover:bg-surface-muted text-body border border-border'
                }`}
              >
                {tab.label}
              </button>
        ...
        <div className="bg-white border border-border rounded-2xl shadow-card overflow-hidden">
          ...
          <div className="px-6 py-4 border-b border-border flex items-center justify-between bg-surface-muted/50">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-bold text-heading">قائمة الحجوزات الطبية</h2>
              <span className="px-2 py-0.5 rounded-md bg-white border border-border text-[11px] font-bold text-muted">
